...
public class UserView {
	...
	public void createUser(List<Person> users, List <Vehicle> vehicles) throws LicenseException {
		int option;
		...
		JOptionPane.showMessageDialog(null, "Un cop creat el titular, ja podem crear el vehicle");
